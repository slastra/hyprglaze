...
pub const Context = struct {
    ...
    pub fn init(allocator: std.mem.Allocator, width: f32, height: f32, params: config_mod.EffectParams) !Context {
        ...
        return .{
            .allocator = allocator,
            .audio = audio,
            .rng = std.Random.DefaultPrng.init(0x7175696c6c), // "quill"
            .width = width,
            .height = height,
            .thread_count = count,
    ...
    pub fn upload(self: *Context, prog: *const shader_mod.ShaderProgram) void {
        ...
        if (self.cached_program != prog.program) {
            ...
            self.loc_pts = c.glGetUniformLocation(prog.program, "iQuillPts[0]");
            ...
            self.loc_time = c.glGetUniformLocation(prog.program, "iQuillTime");
